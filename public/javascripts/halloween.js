...
function ObjectBase(texture_path) {
    ...
    this.setAnimation = function () {
        ...
        this._animation = new arc.display.SheetMovieClip(GameCtrl.prototype.GAME_SYSTEM.getImage("/images/halloween/boss.png"), 100, 6, true, false);
    ...
    if (boss_parameter.timer % 60 == 0) {
        ...
        if (boss_parameter.timer < 600) {
            for (var i = 0; i < 5; i += 1) {
                ...
                p.initialize("/images/halloween/particle02.png")
...
function initializeMain() {
    ...
    // create textures
    var texPath = ["/images/halloween/bg.png", "/images/halloween/bg.png", "/images/halloween/player_info.png", "/images/halloween/black.png", "/images/halloween/info_line.png"];
    for (var i = 0; i < 5; i += 1) {
    ...
    ************************************************/
    ...
    var t = ["/images/halloween/grade1.png", "/images/halloween/grade2.png", "/images/halloween/grade3.png", "/images/halloween/grade4.png"];
    for (var i = 0; i < 4; i += 1) {
    ...
    this._particleManager = new ParticleManager();
    var player = ObjectFactory.create("Player", "/images/halloween/player.png");
...
function updateMain() {
    ...
    if (GameCtrl.prototype.BOSS_DEAD) {
        this.breakObject("/images/halloween/particle01.png", 36, this._frameTimer, 100, 110, 40);
        if (this._plosionCnt == 5) {
            GameCtrl.prototype.BOSS_FLAG = false;
            GameCtrl.prototype.BOSS_DEAD = false;
            this._frameTimer = 0;
    ...
    ************************************************/  
    ...
    if (this._frameTimer > 600 && randInt(0, 50) > 40 && GameCtrl.prototype.BULLET_MODE == 0 && !GameCtrl.prototype.IS_ITEM_GET) {
        ...
        var item = ObjectFactory.create("Enemy", "/images/halloween/item01.png");
    ...
    if (((this._frameTimer % 12) == 0) && !GameCtrl.prototype.ENABLE_BULLET) {
        ...
        if (GameCtrl.prototype.BULLET_MODE == 0) {
            var bullet = ObjectFactory.create("Bullet", "/images/halloween/bullet01.png");
    ...
    if (GameCtrl.prototype.BULLET_MODE == 2) {
        var textures = ["/images/halloween/particle03.png", "/images/halloween/particle06.png", "/images/halloween/particle07.png"];
...
(function () {
    ...
    window.addEventListener('DOMContentLoaded', function (event) {
        ...
        system.load(["/images/halloween/player.png", "/images/halloween/boss.png", "/images/halloween/bullet01.png","/images/halloween/black.png", "/images/halloween/bg.png","/images/halloween/enemy01.png", "/images/halloween/enemy02.png", "/images/halloween/enemy03.png","/images/halloween/particle01.png", "/images/halloween/particle02.png", "/images/halloween/particle03.png", "/images/halloween/particle04.png", "/images/halloween/particle05.png", "/images/halloween/particle06.png", "/images/halloween/particle07.png","/images/halloween/item01.png", "/images/halloween/item02.png","/images/halloween/effect01.png", "/images/halloween/effect02.png", "/images/halloween/effect03.png","/images/halloween/player_info.png","/images/halloween/info_line.png","/images/halloween/grade1.png", "/images/halloween/grade2.png", "/images/halloween/grade3.png", "/images/halloween/grade4.png"]);
    }, false);
})();
