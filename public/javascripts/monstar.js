...
function ObjectBase(texture_path) {
    ...
    this.collisionDetection = function (other) {
        ...
        if (GameCtrl.prototype.BOSS_FLAG) {
            if (collisionCircle(this._position, new Vector2(other._position.x + 20, other._position.y + 10), this._radius, other._radius)) {
                this.damageEffect("/images/monstar/effect03.png");
    ...
    this.collisionBullet = function (container) {
        for (var i = 0; i < container.getLength(); ) {
            if (collisionCircle(this._position, container.item(i)._position, this._radius + 5, container.item(i)._radius)) {
                ...
                container.remove(i);
                this.damageEffect("/images/monstar/effect02.png");
                return true;
            } else {
                i += 1;
            }
    ...
    this.setAnimation = function () {
        ...
        this._animation = new arc.display.SheetMovieClip(GameCtrl.prototype.GAME_SYSTEM.getImage("/images/monstar/boss.png"), 100, 6, true, false);
    ...
    if (boss_parameter.timer % 60 == 0) {
        ...
        if (boss_parameter.timer < 600) {
            for (var i = 0; i < 5; i += 1) {
                ...
                p.initialize("/images/monstar/particle02.png")
...
function initializeMain() {
    ...
    // create textures
    var texPath = ["/images/monstar/bg.png", "/images/monstar/bg.png", "/images/monstar/player_info.png", "/images/monstar/black.png", "/images/monstar/info_line.png"];
    for (var i = 0; i < 5; i += 1) {
    ...
    ************************************************/
    ...
    var t = ["/images/monstar/grade1.png", "/images/monstar/grade2.png", "/images/monstar/grade3.png", "/images/monstar/grade4.png"];
    for (var i = 0; i < 4; i += 1) {
    ...
    this._particleManager = new ParticleManager();
    var player = ObjectFactory.create("Player", "/images/monstar/player.png");
...
function updateMain() {
    ...
    if (GameCtrl.prototype.BOSS_DEAD) {
        this.breakObject("/images/monstar/particle01.png", 36, this._frameTimer, 100, 110, 40);
        if (this._plosionCnt == 5) {
            GameCtrl.prototype.BOSS_FLAG = false;
            GameCtrl.prototype.BOSS_DEAD = false;
            this._frameTimer = 0;
    ...
    ************************************************/  
    ...
    if (this._frameTimer > 600 && randInt(0, 50) > 40 && GameCtrl.prototype.BULLET_MODE == 0 && !GameCtrl.prototype.IS_ITEM_GET) {
        ...
        var item = ObjectFactory.create("Enemy", "/images/monstar/item01.png");
    ...
    if (!GameCtrl.prototype.WITCH_ITEM) {
        ...
        var item = ObjectFactory.create("Enemy", "/images/monstar/item02.png");
    ...
    if (!GameCtrl.prototype.BOSS_FLAG) {
        if ((this._frameTimer % 12) == 0) {
            var t = randInt(0, 2);
            var texturePath = ["/images/monstar/enemy01.png", "/images/monstar/enemy02.png"];
    ...
    if (GameCtrl.prototype.EMERGE_BOSS){
        ...
        var boss = ObjectFactory.create("Boss", "/images/monstar/boss.png");
    ...
    if (((this._frameTimer % 12) == 0) && !GameCtrl.prototype.ENABLE_BULLET) {
        ...
        if (GameCtrl.prototype.BULLET_MODE == 0) {
            var bullet = ObjectFactory.create("Bullet", "/images/monstar/bullet01.png");
    ...
    if (GameCtrl.prototype.BULLET_MODE == 2) {
        var textures = ["/images/monstar/particle03.png", "/images/monstar/particle06.png", "/images/monstar/particle07.png"];
...
(function () {
    ...
    window.addEventListener('DOMContentLoaded', function (event) {
        ...
        system.load(["/images/monstar/player.png", "/images/monstar/boss.png", "/images/monstar/bullet01.png","/images/monstar/black.png", "/images/monstar/bg.png","/images/monstar/enemy01.png", "/images/monstar/enemy02.png", "/images/monstar/enemy03.png","/images/monstar/particle01.png", "/images/monstar/particle02.png", "/images/monstar/particle03.png", "/images/monstar/particle04.png", "/images/monstar/particle05.png", "/images/monstar/particle06.png", "/images/monstar/particle07.png","/images/monstar/item01.png", "/images/monstar/item02.png","/images/monstar/effect01.png", "/images/monstar/effect02.png", "/images/monstar/effect03.png","/images/monstar/player_info.png","/images/monstar/info_line.png","/images/monstar/grade1.png", "/images/monstar/grade2.png", "/images/monstar/grade3.png", "/images/monstar/grade4.png"]);
    }, false);
})();
